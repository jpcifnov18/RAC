...
<?php 
        ...
        $sql = mysqli_query($Conexion, "SELECT * FROM tbl_adoptante WHERE id_adoptante='$Id_'");

        if($resultado  = mysqli_fetch_assoc($sql)){
            $n3 = $resultado['Apellido'].', '.$resultado['Nombre'];
            $n4 = $resultado['Profesion'];
            $n5 = $resultado['DPI'];
        }
?>
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $estabilidad_lab = $_POST['estabilidad_lab'];
        $horario =$_POST['horario'];
        $hobbie = ($_POST['hobbie']);
            $query ="INSERT INTO tbl_ocupaciones(id_adoptante,trabajo_actual,estabilidad_lab,horario,hobbie) VALUES('$Id_U','$trabajo_actual','$estabilidad_lab','$horario','$hobbie')";
            $resultado = $Conexion->query($query);

            if($resultado){
            echo "<script>alert('Ocupaciones Guardadas')</script>";
...
<body id="page-top">
  ...
  <center><h3>Ingreso de Ocupaciones</h3>
    <h4>Debe Ingresar todos los datos necesarios</h4></center>
     <center><p style="color:black"><?php echo $n3; ?><br>Trabajo: <?php echo $n4; ?>  &nbsp DPI: <?php echo $n5; ?></p></

<fieldset>
 <input type="hidden" name="id" placeholder="" value="<?php echo($Id_)?>" readonly>  
 
</fieldset>
     <p>
    <fieldset> 
    <input type="text" name="trabajo_actual" placeholder="Trabajo Actual" class="form-control form-control-user" tabindex="1" required autofocus>
    </fieldset>  
    </p>
    ...
    <input type="text" name="estabilidad_lab" placeholder="Estabilidad Laboral" class="form-control form-control-user" tabindex="2" required autofocus>
    </fieldset>  
    </p>
    
    <p>
    <fieldset>
    <input type="number" name="horario" placeholder="Horario" class="form-control form-control-user" tabindex="3" required autofocus>
    </fieldset>  
    </p>
    
    <fieldset>
    
    <input type="text" name="hobbie" placeholder=" hobbie" class="form-control form-control-user" tabindex="4" required autofocus>
    </fieldset>
