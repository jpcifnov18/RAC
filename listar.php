        ...
        <!-- /.container-fluid todo formulario aqui -->
         <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Adoptantes</h6>
            </div>
            <div class="card-body">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  <thead>
                   <tr id='titulo'>
                        ...
                        <td style='width:100px'>Ocupacion</td>
    ...
    if ($resultado->num_rows>0) {
     ...
     ?>
                <tr>
                        ...
                        <td>
                            <center>
                            <a href="ocupaciones.php?id=<?php echo $fila['id_adoptante']; ?>">
                            <img src="./image/ocupacion.png" width="30" height="30"><br>
                            </a>
                            </center>
                        </td>
                        <td>
                            ...
                            <img src="./image/family.png" width="30" height="30"><br>
                            </a>
                            </center>
                        </td>
