...
$B_nombres = $_POST['Especie'];



$sql = mysqli_query($Conexion, "SELECT * FROM tbl_especie WHERE Especie='$B_nombres'");

if($resultado = mysqli_fetch_assoc($sql)){
  $v_msn = 'La Especie ya esta ingresada'; 
  $v_nombre= $B_nombres;
  ...
  $sql ="INSERT INTO tbl_especie(Especie)VALUES('$B_nombres')";
  $resultado = $Conexion->query($sql);    
        
     echo "<script>alert('Especie registrado')</script>";
...
<body id="page-top">
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="utilities-border.html">Agregar Raza</a>
          </div>
        </div>
      </li>
  ...
  <center><h3>Ingreso de Adoptantes</h3>
    ...
    <input type="text" name="Especie" placeholder="Ingrese Especie" class="form-control form-control-user" value="<?php echo $v_nombre ?>" tabindex="1" required autofocus>
    </fieldset>
