...
$B_nombres = $_POST['Raza'];



$sql = mysqli_query($Conexion, "SELECT * FROM tbl_raza WHERE Raza='$B_nombres'");

if($resultado = mysqli_fetch_assoc($sql)){
  $v_msn = 'La raza ya esta ingresada'; 
  $v_nombre= $B_nombres;
  ...
  $sql ="INSERT INTO tbl_raza(Raza)VALUES('$B_nombres')";
  $resultado = $Conexion->query($sql);    
        
     echo "<script>alert('Raza registrado')</script>";
...
<body id="page-top">
  ...
  <center><h3>Ingreso de Adoptantes</h3>
    ...
    <input type="text" name="Raza" placeholder="Ingrese Raza" class="form-control form-control-user" value="<?php echo $v_nombre ?>" tabindex="1" required autofocus>
    </fieldset>
