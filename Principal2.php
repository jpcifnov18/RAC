      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="Mascota.php">Agregar</a>
            <a class="collapse-item" href="List_mascota.php">Ver</a>
            <a class="collapse-item" href="Especie.php">Agregar Especie </a>
